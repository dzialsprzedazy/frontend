...
const emit = defineEmits(["close", "author-updated"])
...
const resetForm = () => {
  formData.value = {
    imie: props.author.imie || "",
    nazwisko: props.author.nazwisko || "",
  }
}
...
const handleSubmit = async () => {
  if (!formData.value.imie || !formData.value.nazwisko) {
    showAlert({
      type: "error",
  ...
  try {
    ...
    await api.put(`autors/${props.author.idAutora}`, formData.value)
